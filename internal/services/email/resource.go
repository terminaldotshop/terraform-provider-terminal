...
var _ resource.ResourceWithConfigure = (*EmailResource)(nil)
var _ resource.ResourceWithModifyPlan = (*EmailResource)(nil)
...
func (r *EmailResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
