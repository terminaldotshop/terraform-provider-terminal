...
page_title: "terminal_order Resource - terminal"
subcategory: ""
description: |-
  
---

# terminal_order (Resource)
...
```terraform
resource "terminal_order" "example_order" {
...
- `variants` (Map of Number) Product variants to include in the order, along with their quantities.
